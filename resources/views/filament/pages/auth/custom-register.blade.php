<div class="bg-background-light dark:bg-background-dark min-h-screen flex flex-col font-display">
    ...
    <main class="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div class="w-full max-w-[480px] bg-white dark:bg-[#1c1930] rounded-xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            ...
            <div class="pt-8 px-8 flex flex-col items-center">
                ...
                <h1 class="text-gray-900 dark:text-white text-2xl font-bold text-center">SIGAT</h1>
            ...
            <div class="px-8 mt-6">
                <a href="{{ url('/auth/google/redirect') }}" class="w-full flex items-center justify-center gap-3 border border-gray-300 dark:border-gray-600 rounded-lg h-12 px-5 bg-white dark:bg-transparent text-gray-700 dark:text-gray-200 text-base font-semibold transition-all hover:bg-gray-50 dark:hover:bg-gray-800">
                    <img alt="Google Logo" class="w-5 h-5" src="https://www.gstatic.com/images/branding/product/1x/gsa_512dp.png" />
            ...
            <form wire:submit="register" class="px-8 py-6 space-y-4">
                ...
                <div>
                    ...
                    @error('data.name') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('data.email') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div x-data="{ show: false }">
                    ...
                    @error('data.password') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div x-data="{ show: false }">
                    ...
                    @error('data.passwordConfirmation') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </div>
    ...
    <!-- CSS & Fonts for the Design -->
    <style>
        {{-- Kita bungkus dengan @layer base atau @layer component jika perlu, tapi ini CSS murni --}}
        :root {
