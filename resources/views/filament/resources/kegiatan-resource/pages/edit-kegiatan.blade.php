    ...
    <main class="flex-1 flex flex-col min-w-0 bg-background-light dark:bg-background-dark overflow-hidden">
        ...
        <div class="p-8 max-w-5xl mx-auto w-full overflow-y-auto">
            ...
            <nav class="flex items-center gap-2 mb-4 text-sm font-medium">
                ...
                <span class="text-primary">Edit Kegiatan</span>
            </nav>
            
            <!-- Page Heading -->
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-black tracking-tight mb-2 text-[#100d1b] dark:text-white uppercase">Edit Kegiatan</h1>
                    <p class="text-[#594c9a] dark:text-gray-400">Silahkan perbarui informasi laporan kegiatan di bawah ini.</p>
                </div>
