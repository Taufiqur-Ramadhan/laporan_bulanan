            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="max-w-5xl mx-auto w-full">
                    ...
                    <div class="mb-8 flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-black tracking-tight text-[#100d1b] dark:text-white uppercase transition-colors">Edit Kegiatan</h1>
                        ...
                        <div class="p-8">
                            <form wire:submit="save" class="space-y-6">
                                ...
                                <div class="pt-6 border-t border-[#e9e7f3] dark:border-white/10 flex flex-col sm:flex-row gap-4 justify-end">
                                    <a href="/dashboards/kegiatan" class="px-8 py-3 rounded-lg border border-[#d3cfe7] dark:border-white/20 text-[#100d1b] dark:text-white font-bold text-center hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                        Batal
                                    </a>
                                    <button class="px-8 py-3 rounded-lg bg-primary text-white font-bold shadow-lg shadow-primary/20 hover:bg-opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2" type="submit">
