<div class="bg-background-light dark:bg-background-dark min-h-screen flex font-display standalone-kegiatan overflow-hidden">
    ...
    <style>
        ...
        .fi-ta { border-radius: 1rem !important; overflow: hidden !important; border: 1px solid #e9e7f3 !important; }
    ...
    <main class="flex-1 flex flex-col min-w-0 bg-background-light dark:bg-background-dark overflow-hidden">
        ...
        <!-- Page Content -->
        <div class="p-8 max-w-[1400px] mx-auto w-full overflow-y-auto">
            <!-- Breadcrumbs -->
            <nav class="flex items-center gap-2 mb-4 text-sm font-medium">
                ...
                <span class="text-primary">Daftar Kegiatan</span>
            </nav>
            
            <!-- Page Heading -->
            <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-black tracking-tight mb-2 text-[#100d1b] dark:text-white uppercase">Daftar Kegiatan</h1>
                    <p class="text-[#594c9a] dark:text-gray-400">Kelola dan pantau seluruh laporan kegiatan unit kerja.</p>
                </div>
