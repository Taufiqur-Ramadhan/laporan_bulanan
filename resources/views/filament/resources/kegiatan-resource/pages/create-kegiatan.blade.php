<div class="bg-background-light dark:bg-background-dark min-h-screen flex font-display standalone-kegiatan overflow-hidden">
    <!-- Fonts & Icons -->
    ...
    <style>
        ...
        .standalone-kegiatan { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 9999; }
    ...
    <aside class="w-64 border-r border-[#e9e7f3] dark:border-white/10 bg-white dark:bg-[#1a1630] hidden lg:flex flex-col sticky top-0 h-screen shrink-0">
        <div class="p-6">
            ...
            <nav class="flex flex-col gap-1">
                ...
                <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium bg-primary/10 text-primary" href="/dashboards/kegiatans">
                    <span class="material-symbols-outlined text-xl" style="font-variation-settings: 'FILL' 1">add_box</span>
                    Input Kegiatan
                </a>
                <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium hover:bg-primary/5 text-[#594c9a] dark:text-gray-400" href="/dashboards/activity-logs">
    ...
    <main class="flex-1 flex flex-col min-w-0 bg-background-light dark:bg-background-dark overflow-hidden">
        <!-- Top Navigation Bar -->
        <header class="flex items-center justify-between px-8 py-4 bg-white dark:bg-[#1a1630] border-b border-[#e9e7f3] dark:border-white/10 sticky top-0 z-10">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-3 pl-2 border-l border-[#e9e7f3] dark:border-white/10">
                    <div class="text-right hidden sm:block">
                        <p class="text-xs font-bold dark:text-white leading-none capitalize">{{ $userName }}</p>
        ...
        <!-- Page Content -->
        <div class="p-8 max-w-5xl mx-auto w-full overflow-y-auto">
            <!-- Breadcrumbs -->
            ...
            <!-- Page Heading -->
            <div class="mb-8">
                <h1 class="text-3xl font-black tracking-tight mb-2 text-[#100d1b] dark:text-white uppercase">Input Kegiatan Baru</h1>
            ...
            <div class="bg-white dark:bg-[#1a1630] rounded-xl shadow-sm border border-[#e9e7f3] dark:border-white/10 overflow-hidden">
                <div class="p-8">
                    <form wire:submit="create" class="space-y-6">
                        ...
                        <!-- Action Buttons -->
                        <div class="pt-6 border-t border-[#e9e7f3] dark:border-white/10 flex flex-col sm:flex-row gap-4 justify-end">
                            <a href="/dashboards/kegiatans" class="px-8 py-3 rounded-xl border border-[#d3cfe7] dark:border-white/20 text-[#100d1b] dark:text-white font-bold text-center hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                Batal
                            </a>
                            <button class="px-8 py-3 rounded-xl bg-primary text-white font-bold shadow-lg shadow-primary/20 hover:bg-opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2" type="submit">
