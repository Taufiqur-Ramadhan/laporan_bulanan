<div class="bg-background-light dark:bg-background-dark min-h-screen flex font-display standalone-dashboard overflow-hidden">
    ...
    <style>
        ...
        /* Filament Overrides for the provided design */
        .fi-fo-field-ctn label { font-weight: 600 !important; color: #100d1b !important; font-size: 0.875rem !important; margin-bottom: 0.5rem !important; display: flex !important; align-items: center !important; gap: 0.25rem !important; }
        .dark .fi-fo-field-ctn label { color: #fff !important; }
        .fi-input { border-radius: 0.5rem !important; border: 1px solid #d3cfe7 !important; background: #f9f8fc !important; padding: 0.75rem 1rem !important; }
        .dark .fi-input { background: rgba(255,255,255,0.05) !important; border-color: rgba(255,255,255,0.1) !important; color: #fff !important; }
        .fi-section { border-radius: 0.75rem !important; border: 1px solid #e9e7f3 !important; box-shadow: none !important; margin-bottom: 1.5rem !important; }
        ...
        <aside class="w-64 border-r border-[#e9e7f3] dark:border-white/10 bg-white dark:bg-[#1a1630] hidden lg:flex flex-col sticky top-0 h-screen shrink-0">
            <div class="p-6">
                ...
                <nav class="flex flex-col gap-1">
                    ...
                    <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium bg-primary/10 text-primary" href="/dashboards/kegiatan/lapor">
                        <span class="material-symbols-outlined text-xl" style="font-variation-settings: 'FILL' 1">add_box</span>
                        Input Kegiatan
                    </a>
                    <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium hover:bg-primary/5 text-[#594c9a] dark:text-gray-400" href="/dashboards/kegiatan">
            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="max-w-5xl mx-auto w-full">
                    ...
                    <nav class="flex items-center gap-2 mb-4 text-sm font-medium">
                        ...
                        <span class="text-primary">Input Kegiatan Baru</span>
                    </nav>
                    
                    <!-- Page Heading -->
                    <div class="mb-8">
                        <h1 class="text-3xl font-black tracking-tight mb-2 text-[#100d1b] dark:text-white uppercase transition-colors">Input Kegiatan Baru</h1>
                        <p class="text-[#594c9a] dark:text-gray-400">Silahkan lengkapi formulir di bawah ini untuk menambahkan kegiatan baru ke dalam sistem pelaporan SIGAT.</p>
                    </div>

                    <!-- Form Card -->
                    <div class="bg-white dark:bg-[#1a1630] rounded-xl shadow-sm border border-[#e9e7f3] dark:border-white/10 overflow-hidden">
                        <div class="p-8">
                            <form wire:submit="create" class="space-y-6">
                                {{ $this->form }}

                                <!-- Action Buttons -->
                                <div class="pt-6 border-t border-[#e9e7f3] dark:border-white/10 flex flex-col sm:flex-row gap-4">
                                    <a href="/dashboards/kegiatan" class="flex-1 sm:flex-none px-8 py-3 rounded-lg border border-[#d3cfe7] dark:border-white/20 text-[#100d1b] dark:text-white font-bold text-center hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                        Batal
                                    </a>
                                    <button class="flex-1 px-8 py-3 rounded-lg bg-primary text-white font-bold shadow-lg shadow-primary/20 hover:bg-opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2" type="submit">
